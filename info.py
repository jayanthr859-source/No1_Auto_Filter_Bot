...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mammuty:mammuty@cluster0.7piezjk.mongodb.net/?retryWrites=true&w=majority&appName=cluster0")  # MongoDB URI for the database
